    ...
    public class ExporterDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Note>().HasData(
                ...
                new Note() { Id = 1, Text = "Some text about policy 1", PolicyId = 1 },
                new Note() { Id = 1, Text = "Some text about policy 4", PolicyId = 4 },
                new Note() { Id = 1, Text = "Some text about policy 3", PolicyId = 3 },
                new Note() { Id = 1, Text = "Some text about policy 5", PolicyId = 5 },
                new Note() { Id = 1, Text = "Some text about policy 1 (new)", PolicyId = 1 }
                );
